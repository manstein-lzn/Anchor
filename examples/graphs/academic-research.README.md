...
Schema `0012_lease_history` preserves released leases referenced by retrieval
operations when an interrupted Agent is recovered. Only one active lease per
