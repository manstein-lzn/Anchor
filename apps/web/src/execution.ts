export type ExecutionRun = { id: string; task_id: string; graph_version_id: string; status: string; current_phase: string; revision: number; last_event_sequence: number; workflow_version: string; archived_at?: string | null; created_at: string; updated_at: string };
